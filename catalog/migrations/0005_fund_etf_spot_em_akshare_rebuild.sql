-- Rebuild ODS Fund ETF Spot from EM AkShare
-- Drop existing objects first
DROP VIEW IF EXISTS ods.ods_fund_etf_spot_em_akshare;
DROP MACRO IF EXISTS ods.ods_fund_etf_spot_em_akshare_dt;
DROP MACRO IF EXISTS ods._schema_fund_etf_spot_em_akshare;

-- Recreate schema macro
