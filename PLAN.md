...
- [ ] Prefect flows: mirror Airflow DAGs under `prefect/flows/` (start/init/catalog/dw/extractor/backfill/compact)
- [x] Prefect compat layer: `prefect/flows/` package scaffold + env/S3 utils (parallel with Airflow)
